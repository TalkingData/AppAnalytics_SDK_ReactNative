...
import {TalkingDataAppAnalytics, TalkingDataADTShoppingCart, TalkingDataAdTracking} from '../../../TalkingDataAdTracking'
import {KeyboardAwareScrollView} from 'react-native-keyboard-aware-scroll-view'
import {MyTextInput} from "../../common/myTextInput";
import * as RegexUtil from "../../../util/RegexUtil"

export class ADTViewShoppingCartScreen extends React.Component {
                    ...
                    <View style={{marginTop: 50, justifyContent: 'space-between'}}>
                        ...
                        <View style={{marginTop: 20, marginBottom: 20}}>
                            <Button
                                ...
                                onPress={
                                    () => {
                                        TalkingDataAdTracking.onViewShoppingCart(this.state.talkingdataShoppingCart.shoppingCartString);
                                        alert("查看购物车成功")
                                    }
                                }
                            />
