...
export class ADTAddItemScreen extends React.Component {
                                    ...
                                    if (this.state.itemId !== "") {
                                        ...
                                        if (RegexUtil.isNum(this.state.unitPrice)) {
                                            if (RegexUtil.isNaturalNum(this.state.amount)) {
                                                ...
                                                TalkingDataAdTracking.onAddItemToShoppingCart(this.state.itemId,this.state.category,this.state.name,intPrice,intAmount);
                                                alert("添加物品成功")
                                            }else {
                                                alert("物品数量必须为非负数")
                                            }
