...
export class OrderPaySuccessScreen extends React.Component {

    static navigationOptions = ({navigation}) => {
        return {
            headerTitle: <Text style={{fontSize: 20}}>支付订单成功</Text>,
        };
    };
                                ...
                                onPress={
                                    () => {
                                        if (this.state.accountId !== "") {
                                            if (this.state.order != null) {
                                                TalkingDataAppAnalytics.onOrderPaySucc(this.state.accountId, this.state.payType, this.state.order.orderString);
                                                alert("调用支付订单成功接口成功")
                                            } else {
                                                alert("请先生成订单！");
                                            }
